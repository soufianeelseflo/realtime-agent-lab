...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await realtimeAgentLab.getVersion();
            const response = await fetch('https://raw.githubusercontent.com/sohzm/realtime-agent-lab/refs/heads/master/package.json');
    ...
    async _openUpdatePage() {
        ...
        await ipcRenderer.invoke('open-external', 'https://github.com/YOUR_GITHUB_USERNAME/realtime-agent-lab');
    }
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Realtime Agent Lab',
            main: 'Realtime Agent Lab',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'Realtime Agent Lab',
        };
        return titles[this.currentView] || 'Realtime Agent Lab';
    }
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${realtimeAgentLab.isMacOS ? 'Cmd' : 'Ctrl'}</span
