...
export class HelpView extends LitElement {
    ...
    async _loadKeybinds() {
        try {
            const keybinds = await realtimeAgentLab.storage.getKeybinds();
            if (keybinds) {
            ...
            <div class="unified-page">
                <div class="unified-wrap">
                    ...
                    <section class="surface">
                        ...
                        <div class="link-row">
                            <button class="link-button" @click=${() => this._open('https://github.com/YOUR_GITHUB_USERNAME/realtime-agent-lab')}>Website</button>
                            <button class="link-button" @click=${() => this._open('https://github.com/sohzm/realtime-agent-lab')}>GitHub</button>
